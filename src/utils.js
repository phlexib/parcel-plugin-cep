...
function getConfig(package) {
  ...
  const config = defaultsDeep({
    ...
    iconNormal: package.cep && package.cep.iconNormal,
    iconRollover: package.cep && package.cep.iconRollover,
    iconDarkNormal: package.cep && package.cep.iconDarkNormal,
    iconDarkRollover: package.cep && package.cep.iconDarkRollover,
    panelWidth: package.cep && package.cep.panelWidth,
    panelHeight: package.cep && package.cep.panelHeight,
    debugPorts: package.cep && package.cep.debugPorts,
    debugInProduction: package.cep && package.cep.debugInProduction,
    lifecycle: package.cep && package.cep.lifecycle,
  }, {
...
async function symlinkExtension({
  bundleId,
  out
}) {
